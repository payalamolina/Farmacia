...
namespace Farmacia {
    ...
    public partial class DataSet : global::System.Data.DataSet {
        ...
        public partial class MedicamentoDataTable : global::System.Data.TypedTableBase<MedicamentoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public MedicamentoRow AddMedicamentoRow(string Descripcion, double Precio, int Existencia, CategoriaRow parentCategoriaRowByCategoria_Medicamento, TipoRow parentTipoRowByTipo_Medicamento, byte[] Foto, bool Activo) {
                ...
                if ((parentCategoriaRowByCategoria_Medicamento != null)) {
                    columnValuesArray[4] = parentCategoriaRowByCategoria_Medicamento[0];
                }
                if ((parentTipoRowByTipo_Medicamento != null)) {
                    columnValuesArray[5] = parentTipoRowByTipo_Medicamento[0];
                }
...
namespace Farmacia.DataSetTableAdapters {
    ...
    public partial class MedicamentoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Medicamento] ([Descripcion], [Precio], [Existencia], [CategoriaId], [TipoId], [Foto], [Activo]) VALUES (@Descripcion, @Precio, @Existencia, @CategoriaId, @TipoId, @Foto, @Activo);
SELECT Id, Descripcion, Precio, Existencia, CategoriaId, TipoId, Foto, Activo FROM Medicamento WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Medicamento] SET [Descripcion] = @Descripcion, [Precio] = @Precio, [Existencia] = @Existencia, [CategoriaId] = @CategoriaId, [TipoId] = @TipoId, [Foto] = @Foto, [Activo] = @Activo WHERE (([Id] = @Original_Id) AND ([Precio] = @Original_Precio) AND ([Existencia] = @Original_Existencia) AND ([CategoriaId] = @Original_CategoriaId) AND ([TipoId] = @Original_TipoId) AND ([Activo] = @Original_Activo));
SELECT Id, Descripcion, Precio, Existencia, CategoriaId, TipoId, Foto, Activo FROM Medicamento WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Farmacia.Properties.Settings.Default.SuministrosConnectionString;
        }
